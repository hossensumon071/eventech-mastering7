...
<section id="main-container" class="main-container">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6">
                <h2 class="intro-title">Who Should Attend</h2>
                <h3 class="title-classic left">What to Expect from Eventor</h3>
            ...
            <div class="col-md-6">
                <div class="feature-box">
                    <span class="feature-box-media">
                        <img src="images/icons/keynotes.png" alt="">
                    </span>
                    <div class="feature-box-content">
                        <h3 class="feature-title">Inspiring Keynotes</h3>
                        <p>Tofu mixtape twee, assumenda quinoa flexitarian aesthetic artisan vinyl pug. Chambray et Carles Thundercats cardigan actually.</p>
                    </div>
                </div><!-- Feature box 1 end -->

                <div class="feature-box">
                    <span class="feature-box-media">
                        <img src="images/icons/reinvent.png" alt="">
                    </span>
                    <div class="feature-box-content">
                        <h3 class="feature-title">Reinventing Experiences</h3>
                        <p>Tofu mixtape twee, assumenda quinoa flexitarian aesthetic artisan vinyl pug. Chambray et Carles Thundercats cardigan actually.</p>
                    </div>
                ...
                <div class="feature-box last">
                    ...
                    <div class="feature-box-content">
                        <h3 class="feature-title">Fun, Friends &amp; Food</h3>
                        <p>Tofu mixtape twee, assumenda quinoa flexitarian aesthetic artisan vinyl pug. Chambray et Carles Thundercats cardigan actually.</p>
                    </div>
...
<section id="attendees-chart" class="attendees-chart solid-bg">
    <div class="container">
        <div class="row text-center">
            <h2 class="section-title">Success at a galance</h2>
            <h3 class="section-sub-title">Attendees increasing value</h3>
        </div><!--/ Title row end -->

        <div class="row">
            <div class="col-sm-3">
                <div class="percent-area">
                    <div class="chart" data-percent="71" data-delay="100">
                        <span class="percent"></span>
                        <small>2014</small>
                    </div><!-- Chart end -->
                </div><!-- Percent area end -->
            </div><!-- Col 1 end -->

            <div class="col-sm-3">
                <div class="percent-area">
                    <div class="chart" data-percent="75" data-delay="100">
                        <span class="percent"></span>
                        <small>2015</small>
                    </div><!-- Chart end -->
                </div><!-- Percent area end -->
            ...
            <div class="col-sm-3">
                <div class="percent-area">
                    <div class="chart" data-percent="81" data-delay="100">
                        <span class="percent"></span>
                        <small>2016</small>
                    </div><!-- Chart end -->
                </div><!-- Percent area end -->
            ...
            <div class="col-sm-3">
                <div class="percent-area last">
                    <div class="chart" data-percent="87" data-delay="100">
                        <span class="percent"></span>
                        <small>2017</small>
                    </div><!-- Chart end -->
                </div><!-- Percent area end -->
